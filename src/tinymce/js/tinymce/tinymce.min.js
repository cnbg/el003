...
! function() {
					...
					if (t) {
						...
						for (t = (t = t.replace(/[\u0000-\u001F]/g, "")).replace(/\\[\"\';:\uFEFF]/g, g).replace(/\"[^\"]+\"|\'[^\']+\'/g, (e => e.replace(/[;:]/g, g))); s = o.exec(t);) {
							...
							if (t && d) {
								...
								"font-weight" === t && "700" === d ? d = "bold" : "color" !== t && "background-color" !== t || (d = d.toLowerCase()), "rgb" == (x = d, js.test(x) ? "rgb" : Hs.test(x) ? "rgba" : "other") && Vs(d).each((e => {
		...
		bind(e, t, n, o) {
			...
			for (; c--;) {
				let t = d[c],
					...
					m = !1,
					f = !1;
				"DOMContentLoaded" === t && (t = "ready"), r.domLoaded && "ready" === t && "complete" === e.readyState ? n.call(o, ea({
					type: t
				...
				}), s = r.events[l][t], s ? "ready" === t && r.domLoaded ? n(ea({
					type: t
				})) : s.push({
					func: n,
					scope: o
	...
	const oa = Dt.each,
		...
		ua = (e, t, n) => {
			const o = la(t);
			y(n) || "" === n ? po(e, o) : lo(e, o, ((e, t) => x(e) ? ke(aa, t) ? e + "" : e + "px" : e)(n, o))
		},
		ma = (e, t = {}) => {
			const n = {},
				o = window,
	...
	const pa = {},
		...
		va = {
			...
			isRtl: () => ba().bind((e => Ee(e, "_dir"))).exists((e => "rtl" === e)),
			hasCode: e => ke(pa, e)
		},
		ya = () => {
			const e = [],
	...
	const Ji = (e, t) => {
		...
		ll = (e, t) => {
			...
			if (tl(r)) n = ((e, t) => {
				let n = e;
				for (;
					(n = n.previousSibling) && tl(n);) t += n.data.length;
				return t
			})(r, s);
			else {
		...
		vl = (e, t) => {
			...
			return el(n, o, c), e.moveToBookmark({
				id: r,
				keep: !0,
				forward: l
			}), {
	...
	const xu = vr,
		...
		Ou = (e, t, n) => {
			...
			if (Eu(i)) {
				...
				})(n, r) : !Nu(r) && (s = au(r, e, Ru, r), s) ? Eu(s) ? Qi(s, 0) : Qi.before(s) : Eu(r) ? Qi(r, 0) : Qi.after(r);
				o = r || a.getNode()
			}
	...
	const uf = (e, t, n) => !n.collapsed && $(n.getClientRects(), (n => ((e, t, n) => t >= e.left && t <= e.right && n >= e.top && n <= e.bottom)(n, e, t))),
		...
		kf = (e, t) => {
			...
			const x = e => C(e) && (hr(e) || n.is(e, "figure.image")),
				...
				A = e => {
					let o, r, c, C, k;
					o = e.screenX - u, r = e.screenY - m, b = o * d[2] + f, v = r * d[3] + g, b = b < 5 ? 5 : b, v = v < 5 ? 5 : v, c = (x(a) || E(a)) && !1 !== yd(t) ? !yf.modifierPressed(e) : yf.modifierPressed(e), c && (wf(o) > wf(r) ? (v = xf(b * p), b = xf(v / p)) : (b = xf(v / p), v = xf(b * p))), R(i, b, v), C = d.startPos.x + o, k = d.startPos.y + r, C = C > 0 ? C : 0, k = k > 0 ? k : 0, n.setStyles(l, {
						left: C,
						top: k,
						display: "block"
				...
				B = Ca(O, 0),
				P = (e = !0) => {
					B.cancel(), M(), a && e && a.removeAttribute(Cf), pe(Ef, ((e, t) => {
	...
	const ng = e => "textarea" === $t(e),
		...
		ag = (e, t, n, o) => {
			...
			const a = ((e, t) => {
				const n = ((e, t) => {
						const n = In(e);
						if (0 === n.length || ng(e)) return {
							element: e,
							offset: t
						};
						if (t < n.length && !ng(n[t])) return {
							element: n[t],
							offset: 0
						};
						{
	...
	const Bg = ma.DOM,
		...
		Mg = (e, t) => {
			...
			n.on("focusin", (() => {
				...
				Pg(Lg(n)) && o(n, mn), t !== n && (t && t.dispatch("blur", {
					focusedEditor: n
				...
				Tg.setEditorTimeout(n, (() => {
					const t = e.focusedEditor;
					Pg(Lg(n)) && t === n || o(n, gn), Dg(n, Lg(n)) || t !== n || (n.dispatch("blur", {
						focusedEditor: null
	...
	const Cp = ["font", "text-decoration", "text-emphasis"],
		...
		_h = (e, t, n, o = !0, r = !1) => {
			...
			e.dom.isEmpty(e.getBody()) ? (e.setContent(""), e.selection.setCursorLocation()) : a.bind((t => ((e, t, n) => {
				if (Tr(e, t)) {
					...
					return n ? q(In(t), (e => {
						jm(e) || Eo(e)
					})) : xo(t), yo(t, e), I.some(Qi.before(e.dom))
				}
				return I.none()
			})(e.schema, t, r))).fold((() => {
				o && Eh(e, t, l)
		...
		Sh = /[\u0591-\u07FF\uFB1D-\uFDFF\uFE70-\uFEFC]/,
		Nh = (e, t) => En(Cn(t), bd(e)) && !Zr(e.schema, t) && e.dom.isEditable(t),
		Rh = e => {
			var t;
			return "rtl" === ma.DOM.getStyle(e, "direction", !0) || (e => Sh.test(e))(null !== (t = e.textContent) && void 0 !== t ? t : "")
		},
		Ah = (e, t, n) => {
		...
		zh = (e, t, n, o = !0) => {
			...
			if (a.dom === e.getBody() ? Ih(e, o) : Tr(e.schema, a, {
					checkRootAsContent: !1
				}) && (Za(a), o && e.selection.setCursorLocation(a.dom, 0)), !_n(n, a)) {
		...
		Jh = (e, t) => {
			...
			return ((e, t, n) => e.exists((e => ((e, t) => !Wh(e) && Kh(e, t).exists((e => {
			...
			})))(e, n) && pm(e.start, t))))(o, t, n) ? o.map((e => Vh.singleCellTable(t, e.start))) : r.isMultiTable ? ((e, t, n, o) => Gh(e, t, n, o).bind((({
				start: e,
				end: o
			}) => {
				...
				return I.none()
			})))(o, r, t, n) : ((e, t, n, o) => Gh(e, t, n, o).bind((({
				start: e,
				end: t
			}) => e.or(t))).bind((e => {
				const {
		...
		Pb = (e, t, n, o) => {
			...
			return s ? c(1) ? ((e, t, n) => {
			...
			})(s, a, d) : c(2) ? ((e, t, n, o) => (o.insertAfter(t.reverse(), e), Bb(t[0], n)))(s, a, d, t) : ((e, t, n, o) => {
				const r = ((e, t) => {
				...
				return s && (s.insertBefore(r[0], e), Dt.each(t, (t => {
					s.insertBefore(t, e)
				})), s.insertBefore(r[1], e), s.removeChild(e)), Bb(t[t.length - 1], n)
			})(s, a, d, n) : null
		},
		Db = ["pre"],
		Lb = yr,
	...
	const iv = ["fontWeight", "fontStyle", "color", "fontSize", "fontFamily"],
		...
		Dv = (e, t, n, o, r) => {
			const s = e.dom,
				a = hb(e),
				i = e.schema;
			if (Fm(t) && Gr(i, t.inline) && Zr(i, o) && o.parentElement === e.getBody()) return Tv(e, o, t), wv.removed();
			...
			if ("all" !== t.remove) {
				Pv(s, l, t, n, r), Ev(t.attributes, ((e, o) => {
					const {
						name: a,
						value: i
					} = Ov(o, e, n);
		...
		Mv = (e, t, n, o, r) => {
			(o || e.selection.isEditable()) && ((e, t, n, o, r) => {
				...
				if (o) {
					...
					gf(e, t, o, n)
				} else l.isCollapsed() && Fm(a) && !um(e).length ? tv(e, t, n, r) : (xm(e, (() => vm(e, f)), (o => Fm(a) && Kb(e, t, n, o))), e.nodeChanged()), ((e, t, n) => {
		...
		jv = (e, t, n, o) => {
			const r = e.formatter.get(t),
				...
				l = e.selection,
				d = (e, t = s) => {
					w(t.onformat) && t.onformat(e, t, n, o), zv(i, e, t, n), Uv(t.attributes, ((t, o) => {
				...
				f = (o, a, i) => {
					...
					of(o, a, (a => {
						...
						})(o, s, 0, a), bv(e, s, 0, a)) : o.remove(a, !0)
					}))
				},
				g = Cm(o) ? o : l.getNode();
			...
			if (s) {
				if (o)
					...
					var c, u
				})(e, t, n) : (l.setRng(Rb(l.getRng())), xm(e, (() => {
					vm(e, ((e, t) => {
						const n = t ? e : nf(i, e, r);
						f(i, n, !1)
					}))
				}), M), e.nodeChanged()), lv(e.formatter, t).each((t => {
					q((e => Y((e => {
	...
	var nC = function e() {
		...
		const {
			...
			DOMParser: f,
			trustedTypes: g
		} = t, p = d.prototype, h = Py(p, "cloneNode"), b = Py(p, "nextSibling"), v = Py(p, "childNodes"), y = Py(p, "parentNode");
		...
		const Te = function(e) {
			...
			Me = function(e) {
				...
				if (Le("uponSanitizeElement", e, {
						tagName: r,
						allowedTags: M
					}), e.hasChildNodes() && !De(e.firstElementChild) && (!De(e.content) || !De(e.content.firstElementChild)) && Ny(/<[/\w]/g, e.innerHTML) && Ny(/<[/\w]/g, e.textContent)) return Te(e), !0;
				if (!M[r] || j[r]) {
					if (!j[r] && Fe(r)) {
				...
				}(e) ? (Te(e), !0) : "noscript" !== r && "noembed" !== r && "noframes" !== r || !Ny(/<\/no(script|embed|frames)/i, e.innerHTML) ? (K && 3 === e.nodeType && (t = e.textContent, t = ky(t, R, " "), t = ky(t, A, " "), t = ky(t, T, " "), e.textContent !== t && (Cy(n.removed, {
					element: e.cloneNode()
			...
			Ie = function(e, t, n) {
				...
				if (V && !H[t] && Ny(O, t));
					...
					if (!(Fe(e) && (z.tagNameCheck instanceof RegExp && Ny(z.tagNameCheck, e) || z.tagNameCheck instanceof Function && z.tagNameCheck(e)) && (z.attributeNameCheck instanceof RegExp && Ny(z.attributeNameCheck, t) || z.attributeNameCheck instanceof Function && z.attributeNameCheck(t)) || "is" === t && z.allowCustomizedBuiltInElements && (z.tagNameCheck instanceof RegExp && Ny(z.tagNameCheck, n) || z.tagNameCheck instanceof Function && z.tagNameCheck(n)))) return !1
				} else if (de[t]);
				else if (Ny(L, ky(n, D, "")));
	...
	const fC = (e, t, n, o, r) => {
		...
		gC = (e, t, n, o, r, s) => "html" !== n && !Mr(o) || !(r in cC && lC(e, s, o)) && (!e.validate || t.isValid(o, r) || $e(r, "data-") || $e(r, "aria-")),
		...
		vC = (e, t, n) => {
			...
			return o.addHook("uponSanitizeElement", ((o, r) => {
				...
				((e, t, n, o, r) => {
					...
					r.keepAttr = gC(t, n, o, s, a, i), r.keepAttr ? (r.allowedAttributes[a] = !0, hC(a, n) && (r.attrValue = a), t.allow_svg_data_urls && $e(i, "data:image/svg+xml") && (r.forceKeepAttr = !0)) : pC(e, a) && (r.forceKeepAttr = !0)
				})(o, e, t, n.current(), r)
			})), o
		},
		yC = e => {
		...
		xC = (e, t, n, o) => {
			...
			for (let t = 0, r = a.length; t < r; t++) {
				...
				Mr(i.name) || xC(i, r, n, o), e.append(i)
			}
		},
		EC = (e = {}, t = Fs()) => {
			const n = Gv(),
				...
				t.convert_unsafe_embeds && e.addNodeFilter("object,embed", (e => q(e, (e => {
					e.replace((({
						...
						return i.attr("audio" === a ? {
							...
							width: n,
							height: o
						}), "audio" !== a && "video" !== a || i.attr("controls", ""), "iframe" === a && r && ay(i, s), i
					})({
						type: e.attr("type"),
		...
		VC = e => ei(e.innerText),
		qC = e => er(e) ? e.outerHTML : dr(e) ? ws.encodeRaw(e.data, !1) : mr(e) ? "\x3c!--" + e.data + "--\x3e" : "",
		WC = (e, t) => (((e, t) => {
			let n = 0;
			q(e, (e => {
				0 === e[0] ? n++ : 1 === e[0] ? (((e, t, n) => {
		...
		nw = e => ({
			...
			undoManager: {
				...
				undo: (t, n, o) => ((e, t, n, o) => {
					let r;
					return t.typing && (t.add(), t.typing = !1, ew(t, !1, n)), o.get() > 0 && (o.set(o.get() - 1), r = t.data[o.get()], GC(e, r, !0), e.setDirty(!0), e.dispatch("Undo", {
						level: r
					})), r
				})(e, t, n, o),
				redo: (t, n) => ((e, t, n) => {
					let o;
					return t.get() < n.length - 1 && (t.set(t.get() + 1), o = n[t.get()], GC(e, o, !1), e.setDirty(!0), e.dispatch("Redo", {
						level: o
					})), o
				})(e, t, n),
				clear: (t, n) => ((e, t, n) => {
			...
			editor: {
				...
				setContent: (t, n) => ((e, t, n) => I.from(e.getBody()).map((o => Ib(t) ? ((e, t, n, o) => {
					...
					if (0 === (n = ei(n)).length || /^\s+$/.test(n)) {
						...
						const s = ql(e);
						return e.schema.isValidChild(t.nodeName.toLowerCase(), s.toLowerCase()) ? (n = r, n = e.dom.createHTML(s, Wl(e), n)) : n || (n = r), Fb(e, n, o.no_selection), {
							content: n,
							html: n
						}
					} {
		...
		lw = (e, t, n, o, r) => {
			e.bind((e => ((o ? bh : hh)(e.dom, o ? e.dom.length : 0, r), t.filter(Yt).map((t => ((e, t, n, o, r) => {
				const s = e.dom,
					a = t.dom,
		...
		uw = (e, t, n, o) => {
			...
			const {
				...
				RC(e, o).each((t => {
					...
					})(o, o.createContextualFragment(n), e.schema), e.selection.setRng(o), bg(e, o), AC(e, n, t)
				}))
			})(o, e, t), l = e => {
				const t = c();
				t.collapse(!!e), u(t)
									...
									if ($e(t, "blob:")) {
										...
										return C(s) ? Promise.resolve(s) : (o = t, $e(o, "blob:") ? (e => fetch(e).then((e => e.ok ? e.blob() : Promise.reject())).catch((() => Promise.reject({
											...
											Zv(r).bind((({
												...
												data: t,
												base64Encoded: n
											}) => Qv(e, t, n))).fold((() => t("Invalid data URI")), e)
	...
	const Zw = (e, t) => {
		...
		ex = e => {
			...
			const r = Gw(),
				...
				c = () => (n || (n = Jw(e, r)), p().then(a((o => {
					...
					return n.upload(r, Qw(e)).then(a((n => {
						...
						const a = V(n, ((n, a) => {
							...
							let c = !1;
							return n.status && ed(e) ? (n.url && !He(l.src, n.url) && (s = !0), t.removeByUri(l.src), ow(e) || ((t, n) => {
								...
								Hw(e, va.translate(["Failed to upload image: {0}", t]))
							})(e, n.error.message)), {
								element: l,
								status: n.status,
								uploadUri: n.url,
				...
				g = e => ne(s, (t => t(e))),
				p = () => (o || (o = Yw(r, t)), o.findAll(e.getBody(), g).then(a((t => {
		...
		cx = (e, t) => {
			...
			})), e.dispatch("PreviewFormats"), ax.setStyles(a, {
				position: "absolute",
				left: -65535
			...
			})), e.dispatch("AfterPreviewFormats"), ax.remove(a), n
		},
		ux = e => {
			const t = (e => {
					const t = {},
		...
		fx = e => {
			...
			return ow(e) || ((e, t, n) => {
				...
				e.on("init", (() => {
					...
					(s >= 33 && s <= 36 || s >= 37 && s <= 40 || 45 === s || n.ctrlKey || a) && (r(), e.nodeChanged()), 46 !== s && 8 !== s || e.nodeChanged(), o.get() && t.typing && !QC(YC(e), t.data[0]) && (e.isDirty() || e.setDirty(!0), e.dispatch("TypingUndo"), o.set(!1), e.nodeChanged())
				})), e.on("keydown", (e => {
					const s = e.keyCode;
		...
		Sx = (e, t, n, o) => (_x(!0, t), _x(!1, n), ((e, t) => Sn(t, e) ? ((e, t) => {
			const n = Up(t, e);
		...
		Tx = e => {
			...
			return ((e, t) => {
				...
				return It(Mh(e, Cn(o.startContainer)), Mh(e, Cn(o.endContainer)), ((r, s) => _n(r, s) ? I.none() : I.some((() => {
					o.deleteContents(), Nx(e, !0, r, s, n).each((e => {
						t.setRng(e.toRange())
					}))
				})))).getOr(I.none())
		...
		Vx = (e, t) => {
			...
			})(e.getBody(), t, e.selection.getRng(), e.schema).map((n => () => n.fold(((e, t) => n => (e._selectionOverrides.hideFakeCaret(), _h(e, t, Cn(n)), !0))(e, t), ((e, t) => n => {
	...
	const WE = (e, t, n, o, r, s) => {
		...
		ok = (e, t, n) => nk(e, t).filter(n).exists((t => (e.selection.setRng(t.toRange()), !0))),
		rk = (e, t) => {
		...
		pk = (e, t, n, o) => {
			...
			e.undoManager.ignore((() => {
				...
				})(n, o)), Dh(e), gE(s, r, Qi.fromRangeStart(e.selection.getRng())).map(vE).bind(gk(e, t)).each(D)
			})), e.nodeChanged()
		},
		hk = (e, t, n) => {
		...
		Dk = (e, t) => {
			...
			const {
				dom: r
			} = e, s = md(e), a = null !== (o = null === (n = /[a-z%]+$/i.exec(s)) || void 0 === n ? void 0 : n[0]) && void 0 !== o ? o : "px", i = Ak(s), l = ud(e);
			q(Pk(e), (e => {
				((e, t, n, o, r, s) => {
					const a = Tk(n, Cn(s)),
						i = Ak(e.getStyle(s, a));
		...
		jk = (e, t) => !!dr(t) || !!er(t) && !(zk(e.getBlockElements(), t) || rm(t) || Zr(e, t) || Ir(t)),
		Hk = (e, t) => {
			if (dr(t)) {
				if (0 === t.data.length) return !0;
				if (/^\s+$/.test(t.data)) return !t.nextSibling || zk(e, t.nextSibling) || Ir(t.nextSibling)
			}
			return !1
		},
		...
		Qk = (e, t) => ((e, t) => {
			...
			return Rh(n) ? !t : t
		})(e.selection, t)).exists((t => (QE(e, t), !0))),
		Jk = (e, t) => ((e, t) => {
			const n = t ? 1 : -1,
				o = e.selection.getRng();
			return ((e, t, n) => tk(t, e, n, (e => Mp(e) || Dp(e)), (e => Ip(e) || Lp(e)), Xk))(n, e, o).orThunk((() => (Zk(e, n, o), I.none())))
		...
		D_ = (e, t, n) => {
			return P_(e, t, (r = ro, v_(o = n, void 0).fold((() => g_.none(o)), (e => b_(e.all, o, e.index, 1, r)))));
			var o, r
		},
		L_ = (e, t, n) => {
			return P_(e, t, (r = ro, v_(o = n, void 0).fold((() => g_.none()), (e => b_(e.all, o, e.index, -1, r)))));
			var o, r
		},
		M_ = (e, t) => {
			const n = ["table", "li", "dl"],
			...
			})), e.selection.collapse(!t), (t ? D_ : L_)(e, r, n).each((t => {
		...
		W_ = (e, t, n, o = !1) => {
			...
			return $_(e, t.startContainer, t.startOffset, ((e, t, r) => (s.text = r + s.text, s.offset += t, ((e, t, n, o = !1) => {
				let r;
				const s = n.charAt(0);
				for (r = t - 1; r >= 0; r--) {
					const a = e.charAt(r);
		...
		mS = (e, t, n, o, r) => {
			const s = e => r.extract(t.concat([o]), e),
				a = e => e.fold((() => Q_(I.none())), (e => {
					...
					return s = n, a = I.some, s.stype === X_.Value ? {
						stype: X_.Value,
						svalue: a(s.svalue)
					} : s;
					var s, a
	...
	const oN = e => {
		...
		rN = e => {
			const t = Dr(),
				...
				i = () => t.get().bind((({
					...
					const o = e.selection.getRng();
					return W_(e.dom, o, t, n.get()).filter((({
						range: e
					}) => ((e, t) => {
		...
		gN = (e, t, n) => ((e, t, n) => ((e, t) => {
			...
			return !!kr(r) && ("selection" === n && iN(s, r) || Fh(t, a, r) ? aN(r) : e.undoManager.transact((() => {
				...
				u(r, m), r.appendChild(m), c(), "word" !== n && "line" !== n || null == s || s.modify("extend", t ? "right" : "left", n), !o.isCollapsed() && iN(o.getRng(), m) ? aN(r) : (e.execCommand(t ? "ForwardDelete" : "Delete"), a = null == s ? void 0 : s.anchorNode, i = null == s ? void 0 : s.anchorOffset, l = null == s ? void 0 : s.focusNode, d = null == s ? void 0 : s.focusOffset, u(m, r), c()), e.dom.remove(m)
			})), !0)
		...
		FN = {
			insert: (e, t) => {
				...
				const i = e.dom,
					...
					w = () => {
						...
						return t = /^(H[1-6]|PRE|FIGURE)$/.test(r) && "HGROUP" !== S ? b(c) : b(), ((e, t) => {
							...
							includeZwsp: !0
						}) ? t = i.split(s, _) : i.insertAfter(t, _), xN(e, t), t
					};
				Yf(i, d).each((e => {
				...
				if ("LI" !== S || E || (_ = s, s = s.parentNode, r = S), er(s) && ((e, t, n) => !t && n.nodeName.toLowerCase() === ql(e) && e.dom.isEmpty(n) && ((t, n, o) => {
						let r = n;
				...
				if (p) R = b(c), f.fold((() => {
					...
					})(i, _), i.isEmpty(_) && _N(_), R.normalize(), i.isEmpty(R) ? (i.remove(R), w()) : (SN(e, R), xN(e, R))
				}
			...
			insert: (e, t) => {
				...
				n.isSome() ? n.each(T(qN, e)) : ((e, t) => {
					...
					"LI" !== u || m || (d = c), dr(l) && i >= l.data.length && (((e, t, n) => {
						...
						return !1
					})(e.schema, l, d || o.getRoot()) || (s = o.create("br"), r.insertNode(s), r.setStartAfter(s), r.setEndAfter(s), a = !0)), s = o.create("br"), el(o, r, s), UN(e, s, a), e.undoManager.add()
				})(e, t)
			},
		...
		aR = (e, t, n) => {
			...
			})(t), C(n) && bN(t, e.fakeEventName).isDefaultPrevented() || (e.insert(t, n), C(n) && hN(t, e.fakeEventName))
		},
		iR = (e, t) => {
			const n = () => aR(WN, e, t),
				o = () => aR(FN, e, t),
		...
		xR = e => {
			if (e.addShortcut("Meta+P", "", "mcePrint"), rN(e), ow(e)) return Br(null);
			{
				const t = ck(e);
				return (e => {
					e.on("beforeinput", (t => {
					...
					e.on("keydown", (t => {
						t.isDefaultPrevented() || ((e, t) => {
							d_([{
								...
								t.preventDefault(), bN(e, "insertText", {
									data: " "
								}).isDefaultPrevented() || (n(), hN(e, "insertText", {
									data: " "
								}))
							}))
						})(e, t)
					...
					e.on("keydown", (t => {
						...
						})(e, t, o), fR(o) && n.get() && (gR(n, e, !1), e.nodeChanged())
					}))
				})(e, t), t
			}
		};
	...
	const OR = Da("mode"),
		...
		lA = (e, t, n, o, r) => {
			...
			if (!s.cancelled) {
				...
				r ? bN(e, "insertFromPaste", {
					dataTransfer: iA(t)
				}).isDefaultPrevented() || (n(), hN(e, "insertFromPaste")) : n()
			}
		},
		dA = (e, t, n, o) => {
			const r = n || YR(t);
		...
		gA = (e, t, n) => {
			...
			if (oc(e) && o) {
				...
				if (s.length > 0) return t.preventDefault(), (r = s, Promise.all(V(r, (e => Jv(e).then((t => ({
					file: e,
					uri: t
				}))))))).then((t => {
		...
		pA = (e, t, n, o, r) => {
			...
			const a = mA(t, qR()) || YR(n),
				...
				l = oA(s);
			(QR(s) || !s.length || i && !l) && (o = !0), (o || l) && (s = mA(t, "text/plain") && i ? t["text/plain"] : (e => {
				const t = Fs(),
					n = EC({}, t);
				let o = "";
		...
		hA = (e, t, n) => {
			((e, t, n) => {
				...
				e.on("keydown", (e => {
					...
					!fA(a) && gA(e, r, t.getLastRng() || e.selection.getRng()) || (mA(a, "text/html") ? (r.preventDefault(), pA(e, a, a["text/html"], s, !0)) : mA(a, "text/plain") && mA(a, "text/uri-list") ? (r.preventDefault(), pA(e, a, a["text/plain"], s, !0)) : (t.create(), Tg.setEditorTimeout(e, (() => {
						const n = t.getHtml();
		...
		kA = e => Dt.trim(e).replace(EA, Ws).toLowerCase(),
		_A = (e, t, n) => {
			const o = ic(e);
		...
		PA = e => {
			const t = ((e, t, n) => {
				...
				}), (e => i.setStartBefore(e.dom))), OA(a, r).fold((() => {
	...
	const LA = (e, t) => Math.abs(e.left - t),
		...
		$A = (e, t, n, o) => {
			const r = ((e, t) => {
				const n = (e => {
					...
					return LR(e), NR(t), t.dropEffect = e.dropEffect, t.effectAllowed = e.effectAllowed, (e => {
						const t = e;
						return I.from(t[kR])
		...
		eT = (e, t) => {
			const n = Ca(((e, n) => ((e, t, n) => {
				e._selectionOverrides.hideFakeCaret(), zA(e.getBody(), t, n).fold((() => e.selection.placeCaretAt(t, n)), (o => {
			...
			return r => e.on((e => {
				...
				if (e.dragging) {
					...
					a = e.ghost, i = t.getBody(), a.parentNode !== i && i.appendChild(a), ((e, t, n, o, r, s, a, i, l, d, c, u) => {
						...
						c.on((e => {
							e.intervalId.clear(), e.dragging && u && (a + 8 >= g ? e.intervalId.set(ZA(d)) : a - 8 <= 0 ? e.intervalId.set(XA(d)) : i + 8 >= p ? e.intervalId.set(GA(d)) : i - 8 <= 0 ? e.intervalId.set(YA(d)) : h + 16 >= window.innerHeight ? e.intervalId.set(ZA(window)) : h - 16 <= 0 ? e.intervalId.set(XA(window)) : b + 16 >= window.innerWidth ? e.intervalId.set(GA(window)) : b - 16 <= 0 && e.intervalId.set(YA(window)))
						}))
		...
		tT = (e, t, n) => {
			e.on((e => {
				e.intervalId.clear(), e.dragging && n.fold((() => JA(t, "dragend", e.element, e.dataTransfer)), (n => JA(t, "dragend", e.element, e.dataTransfer, n)))
			})), nT(e)
		},
		nT = e => {
			e.on((e => {
		...
		aT = e => {
			...
			return ow(e) || (e.on("click", (t => {
				...
				g(), p();
				const a = sT(e, s);
				rT(a) ? (r.preventDefault(), Px(e, a).each(f)) : zA(o, r.clientX, r.clientY).each((n => {
					var o;
		...
		fT = (e, t, n, o = !0) => {
			...
			t.deleteContents(), o && !n(t.startContainer) && (dr(t.startContainer) && 0 === t.startContainer.data.length && e.remove(t.startContainer), dr(t.endContainer) && 0 === t.endContainer.data.length && e.remove(t.endContainer), mT(e, r, n), r !== s && mT(e, s, n))
		},
		...
		xT = (e, t, n, o) => {
			const r = t.start;
			var s;
			return $_(e, o.container, o.offset, (s = r, (e, t) => {
		...
		ST = (e, t, n, o, r, s) => {
			...
			})(kT(e, r.inlinePatterns, n, o, t, s).fold((() => []), (e => e.matches)), kT(e, (a = r.inlinePatterns, ae(a, ((e, t) => t.end.length - e.end.length))), n, o, t, s).fold((() => []), (e => e.matches)))
		},
		NT = (e, t) => {
			...
			q(r, (t => {
				...
				wT(t.pattern) ? ((e, t, n, o) => {
					...
					const l = {
						...
						d = vT(s, l);
					_T(e, t, d)
				})(e, t.pattern, t.startMarker, t.endMarker, r), CT(n, t.endMarker, r), CT(n, t.startMarker, r)
		...
		zT = e => {
			const t = Dt.each,
				...
				N = k;
			return ow(e) ? (d && (p(), b(), S(), g(), c && (w(), x(), _())), l && (h(), y(), C(), E())) : (e.on("keydown", (t => {
		...
		KT = e => {
			...
			const a = Promise.all(((e, t, n) => {
					const {
						pass: o,
						fail: r
					} = K(t, (e => tinymce.Resource.has(Ww(e)))), s = o.map((t => {
		...
		GT = e => {
			...
			const o = e.getBody();
			o.disabled = !0, e.readonly = zd(e), e._editableRoot = jd(e), !e.readonly && e.hasEditableRoot() && (e.inline && "static" === jT.getStyle(o, "position", !0) && (o.style.position = "relative"), o.contentEditable = "true"), o.disabled = !1, e.editorUpload = ex(e), e.schema = Fs(qT(e)), e.dom = ma(n, {
				keep_values: !0,
			...
			})(e), e), e.selection = uw(e.dom, e.getWin(), e.serializer, e), e.annotator = df(e), e.formatter = ux(e), e.undoManager = fx(e), e._nodeChangeDispatcher = new ER(e), e._selectionOverrides = aT(e), (e => {
				const t = Dr(),
					n = Br(!1),
					o = wa((t => {
			...
			Fk(e, r), (e => {
				...
				const n = e.dom,
					...
					s = (t, a) => {
						...
						("" !== n.getAttrib(i, px) !== l || a) && (n.setAttrib(i, px, l ? r : null), ((e, t) => {
			...
			const s = (e => {
				const t = e;
				return (e => Ee(e.plugins, "rtc").bind((e => I.from(e.setup))))(e).fold((() => (t.rtcInstance = nw(e), I.none())), (e => (t.rtcInstance = (() => {
					const e = N(null),
						t = N("");
					return {
						init: {
			...
			(e => {
				...
				(e => {
					e.dispatch("PreInit")
				})(e), ec(e) || (t.body.spellcheck = !1, jT.setAttrib(n, "spellcheck", "false")), e.quirks = zT(e), (e => {
				...
				e.setProgressState(!0), KT(e).then((() => {
					t().then((t => {
		...
		tO = async e => {
			...
			const t = await (e => {
				const t = e.getElement();
				return e.orgDisplay = t.style.display, m(Ed(e)) ? (e => {
			...
			((e, t) => {
				...
				((e, t) => {
					...
					})(e), ZT.add(t.iframeContainer, s)
				})(e, t), t.editorContainer && (t.editorContainer.style.display = e.orgDisplay, e.hidden = ZT.isHidden(t.editorContainer)), e.getElement().style.display = "none", ZT.setAttrib(e.id, "aria-hidden", "true"), e.getElement().style.visibility = e.orgVisibility, (e => {
		...
		}, nO = ma.DOM, oO = e => "-" === e.charAt(0), rO = (e, t, n) => I.from(t).filter((e => Ge(e) && !Aw.has(e))).map((t => ({
		...
		}, aO = Et().deviceType, iO = aO.isPhone(), lO = aO.isTablet(), dO = e => {
			if (y(e)) return [];
			{
			...
			return /^ | $/.test(t) ? ((e, t, n, o) => {
				...
				return n = ih(r, Qi.fromRangeStart(t), o) ? n.replace(/^ /, "&nbsp;") : n.replace(/^&nbsp;/, " "), lh(r, Qi.fromRangeEnd(t), o) ? n.replace(/(&nbsp;| )(<br( \/)>)?$/, "&nbsp;") : n.replace(/&nbsp;(<br( \/)?>)?$/, " ")
			...
			"font-size": "size",
			"font-family": "face"
		}, yO = Zt("font"), CO = e => (t, n) => I.from(n).map(Cn).filter(Kt).bind((n => ((e, t, n) => zb(Cn(n), (t => (t => fo(t, e).orThunk((() => yO(t) ? Ee(vO, e).bind((e => nn(t, e))) : I.none())))(t)), (e => _n(Cn(t), e))))(e, t, n.dom).or(((e, t) => I.from(ma.DOM.getStyle(t, e, !0)))(e, n.dom)))).getOr(""), wO = CO("font-size"), xO = _((e => e.replace(/[\'\"\\]/g, "").replace(/,\s+/g, ",")), CO("font-family")), EO = e => Hu(e.getBody()).bind((e => {
			const t = e.container();
		...
		})))(e).orThunk(T(EO, e)).map(Cn).filter(Kt).bind(t))(e, S(I.some, t)), _O = (e, t) => {
			if (/^[0-9.]+$/.test(t)) {
			...
			pO(e), (e => {
				...
				(e => {
					...
					}, "state"), e.editorCommands.addQueryValueHandler("FontName", (() => (e => kO(e, (t => xO(e.getBody(), t.dom))).getOr(""))(e))), e.editorCommands.addQueryValueHandler("FontSize", (() => (e => kO(e, (t => wO(e.getBody(), t.dom))).getOr(""))(e))), e.editorCommands.addQueryValueHandler("LineHeight", (() => (e => kO(e, (t => {
						const n = Cn(e.getBody()),
						...
						((e, t) => {
							e.removed || (t ? Hg(e) : (e => {
								const t = e.selection,
									n = e.getBody();
								let o = t.getRng();
								e.quirks.refreshContentEditable(), C(e.bookmark) && !zg(e) && Rg(e).each((t => {
		...
		}, AO = ["toggleview"], TO = e => H(AO, e.toLowerCase());
	class OO {
		constructor(e) {
			this.commands = {
				state: {},
	...
	const VO = (e, t) => {
		...
		WO = (e, t) => {
			...
			const n = VO(e, t);
			if (wd(e)) {
				if ($O || ($O = {}, e.editorManager.on("removeEditor", (() => {
		...
		KO = {
			...
			toggleNativeEvent(e, t) {
				const n = this;
				"focus" !== e && "blur" !== e && (n.removed || (t ? n.initialized ? WO(n, e) : n._pendingNativeEvents ? n._pendingNativeEvents.push(e) : n._pendingNativeEvents = [e] : n.initialized && n.delegates && (n.dom.unbind(VO(n, e), e, n.delegates[e]), delete n.delegates[e])))
			},
		...
		JO = (e, t, n, o) => {
			...
			r.deactivate(), r.editorReadOnly !== s.editorReadOnly && ((e, t) => {
				...
				})(e), e.readonly = !0, DO(n, !1), q(zo(n, '*[contenteditable="true"]'), (e => {
					Jt(e, BO, "true"), DO(e, !1)
				}))) : (e.readonly = !1, e.hasEditableRoot() && DO(n, !0), q(zo(n, `*[${BO}="true"]`), (e => {
					rn(e, BO), DO(e, !0)
				})), PO(e, "StyleWithCSS", !1), PO(e, "enableInlineTableEditing", !1), PO(e, "enableObjectResizing", !1), jg(e) && e.focus(), (e => {
	...
	class cB {
		constructor(e, t, n) {
			...
			const d = Hd(o);
			C(d) && ma.DOM.styleSheetLoader._setContentCssCors(d), ya.languageLoad = s("language_load"), ya.baseURL = n.baseURL, this.setDirty(!1), this.documentBaseURI = new dC(zl(o), {
				base_uri: this.baseUri
			}), this.baseURI = this.baseUri, this.inline = Pd(o), this.hasVisual = Wd(o), this.shortcuts = new sB(this), this.editorCommands = new OO(this), RO(this);
		...
		render() {
			(e => {
				...
				if (!na.Event.domLoaded) return void nO.bind(window, "ready", n);
				...
				s && (e.formElement = s, Dd(e) && !lr(e.getElement()) && (nO.insertAfter(nO.create("input", {
					type: "hidden",
					name: t
				}), t), e.hasHiddenInput = !0), e.formEventDelegate = t => {
					e.dispatch(t.type, t)
				}, nO.bind(s, "submit reset", e.formEventDelegate), e.on("reset", (() => {
					e.resetContent()
				})), !Ld(e) || s.submit.nodeType || s.submit.length || s._mceOldSubmit || (s._mceOldSubmit = s.submit, s.submit = () => (e.editorManager.triggerSave(), e.setDirty(!1), s._mceOldSubmit(s)))), e.windowManager = zw(e), e.notificationManager = Iw(e), (e => "xml" === e.options.get("encoding"))(e) && e.on("GetContent", (e => {
				...
				}, e.editorManager.on("BeforeUnload", e._beforeUnload)), e.editorManager.add(e), sO(e, e.suffix)
			})(this)
		}
		focus(e) {
		...
		hide() {
			const e = this;
			e.hidden || (e.save(), e.inline ? (e.getBody().contentEditable = "false", e === e.editorManager.focusedEditor && (e.editorManager.focusedEditor = null)) : (iB.hide(e.getContainer()), iB.setStyle(e.id, "display", e.orgDisplay)), e.hidden = !0, e.dispatch("hide"))
		}
		isHidden() {
			return this.hidden
		}
		...
		resetContent(e) {
			void 0 === e ? pw(this, this.startContent, {
				format: "raw"
			}) : pw(this, e), this.undoManager.reset(), this.setDirty(!1), this.nodeChanged()
		}
		isDirty() {
		...
		remove() {
			(e => {
				if (!e.removed) {
					...
					o && e.save({
						is_removing: !0
					}), e.removed = !0, e.unbindAllNativeEvents(), e.hasHiddenInput && C(null == r ? void 0 : r.nextSibling) && Nw.remove(r.nextSibling), (e => {
						e.dispatch("remove")
					})(e), e.editorManager.remove(e), !e.inline && o && (e => {
						Nw.setStyle(e.id, "display", e.orgDisplay)
					})(e), (e => {
						e.dispatch("detach")
					})(e), Nw.remove(e.getContainer()), Rw(t), Rw(n), e.destroy()
				}
			})(this)
		}
		destroy(e) {
			((e, t) => {
				...
				e.destroyed || (t || e.removed ? (t || (e.editorManager.off("beforeunload", e._beforeUnload), e.theme && e.theme.destroy && e.theme.destroy(), Rw(n), Rw(o)), (e => {
	...
	const hB = e => {
		...
		CB = {
				...
				const s = () => {
					...
					uB.unbind(window, "ready", s), (n => {
						...
						((e, t) => e.inline && t.tagName.toLowerCase() in o)(e, s) ? qw("Could not initialize inline editor on invalid inline target element", s): ((e, o, s) => {
							...
							let t = e.id;
							return t || (t = Ee(e, "name").filter((e => !uB.get(e))).getOrThunk(uB.uniqueId), e.setAttribute("id", t)), t
						})(s), e, s)
					}))
				};
				return uB.bind(window, "ready", s), new Promise((e => {
					n ? e(n) : r = t => {
						e(t)
					}
				}))
			...
			remove(e) {
				...
				let n;
				if (e) {
					if (!m(e)) return n = e, h(t.get(n.id)) ? null : (vB(n) && t.dispatch("RemoveEditor", {
						editor: n
					}), 0 === pB.length && window.removeEventListener("beforeunload", fB), n.remove(), bB(pB.length > 0), n);
					mB(uB.select(e), (e => {
						n = t.get(e.id), n && t.remove(n)
					}))
				} else
					for (let e = pB.length - 1; e >= 0; e--) t.remove(pB[e])
			},
			execCommand(e, t, n) {
				var o;
				const r = this,
	...
	const wB = (() => {
		...
		_B = (e, t, n) => {
			...
			const s = e.w,
				...
				l = t.h,
				d = (n || "").split("");
			return "b" === d[0] && (r += l), "r" === d[1] && (o += i), "c" === d[0] && (r += kB(l / 2)), "c" === d[1] && (o += kB(i / 2)), "b" === d[3] && (r -= a), "r" === d[4] && (o -= s), "c" === d[3] && (r -= kB(a / 2)), "c" === d[4] && (o -= kB(s / 2)), SB(o, r, s, a)
		},
		SB = (e, t, n, o) => ({
			x: e,
			y: t,
