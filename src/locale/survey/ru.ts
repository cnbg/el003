...
export const ruStrings = {
  customSurveyPropertyRecomendation: "Рекомендации к вопросу",
  customSurveyPropertyLevel: "Уровни сложности вопроса",

  customSurveyPropertyLevelEasy: "Легкий",
  customSurveyPropertyLevelMedium: "Средний",
  customSurveyPropertyLevelHard: "Сложный",
  customScore: "Балл",
  ...
  noneItemText: "Нет",
  refuseItemText: "Отказаться от ответа",
  dontKnowItemText: "Не знаю",
  selectAllItemText: "Выбрать все",
  ...
  completingSurvey: "Благодарим Вас за заполнение теста!",
  completingSurveyBefore: "Вы уже проходили этот тест.",
  ...
  savingExceedSize: "Ваш ответ превышает 64 КБ. Уменьшите размер файла (файлов) и повторите попытку или обратитесь к владельцу теста.",
  ...
  modalApplyButtonText: "Применить",
  ...
  survey: {
    edit: "Редактировать",
    externalHelpLink: "Научиться создавать тесты",
    externalHelpLinkUrl: "Https://www.youtube.com/channel/UCH2ru9okIcooNZfpIbyq4qQ?view_as=subscriber",
    dropQuestion: "Пожалуйста, перетяните необходимый элемент из панели слева",
    addLogicItem: "Создайте правило для настройки потока теста.",
    copy: "Копировать",
  ...
  ed: {
    ...
    surveySettings: "Настройки теста",
    ...
    testSurvey: "Предварительный просмотр",
    themeSurvey: "Темы",
    ...
    testSurveyWidth: "Ширина теста",
    navigateToMsg: "Вы должны были перейти к",
    logic: "Логика",
    embedSurvey: "Вставить тест",
    translation: "Перевод",
    saveSurvey: "Сохранить тест",
    saveSurveyTooltip: "Сохранить тест",
    ...
    translationAddLanguage: "Выберите дополнительный язык теста",
    ...
    surveyPlaceHolder: "Тест пуст. Перетащите элемент с панели инструментов или нажмите кнопку ниже.",
    ...
    lg: {
      ...
      empty_tab: "Создайте правило для настройки потока теста.",
      ...
      trigger_completeName: "Тест завершен",
      ...
      trigger_completeDescription: "Когда логическое выражение вернет 'true', то тест становится завершенным и конечный пользователь видит 'Страницу благодарности'.",
      ...
      trigger_skipDescription: "Когда логическое выражение вернет 'true', тогда тест переходит к/фокусируется на выбранном вопросе.",
      ...
      trigger_completeText: "Тест становится завершенным",
      ...
      trigger_skipText: "Тест переходит к вопросу {0}", //{0} question name
  ...
  pe: {
    ...
    masksettings: {
      saveMaskedValue: "Сохранение замаскированного значения в результатах теста"
    },
    patternmask: {
    ...
    showPreviewBeforeComplete: "Предварительный просмотр ответов перед отправкой теста",
    ...
    surveyTitlePlaceholder: "Введите заголовок теста",
    pageTitlePlaceholder: "Введите заголовок страницы",
    descriptionPlaceholder: "Введите описание",
    surveyDescriptionPlaceholder: "Введите описание теста",
    ...
    surveyEditorTitle: "Настройки теста",
    ...
    includeIntoResult: "Включить в результаты теста",
    ...
    cookieName: "Имя Cookie (отключить повторное прохождение теста локально)",
    sendResultOnPageNext: "Показать результаты теста на странице рядом",
    ...
    firstPageIsStarted: "Первая страница теста является стартовой страницей.",
    ...
    allowCompleteSurveyAutomatic: "Автоматическое заполнение теста",
    ...
    questionTitleTemplate: "Шаблон названия теста, по умолчанию: {не} {требует} {текста}.",
    questionErrorLocation: "Размещение ошибки теста",
    ...
    maxTimeToFinish: "Максимальное время в секундах, чтобы заполнить тест",
    maxTimeToFinishPage: "Максимальное время в секундах, чтобы заполнить страницу теста",
    ...
    questionsOnPageMode: "Структура теста",
    ...
    completedBeforeHtml: "Разметка, показывающая, заполнил ли пользователь уже этот тест",
    completedHtml: "Тест Полная разметка страницы",
    completedHtmlOnCondition: "Динамический тест Полная разметка страницы",
    loadingHtml: "Разметка, отображаемая при загрузке модели теста",
    ...
    tabs: {
      ...
      logo: "Логотип в заголовке теста",
      slider: "Ползун",
      expression: "Выражение",
    ...
    noquestions: "В тесте нет ни одного вопроса",
    ...
    triggerCompleteText: "Завершить тест, если все получися.",
    ...
    triggerIsVariable: "Не помещать переменную в результат теста.",
  ...
  ew: {
    ...
    showOnPage: "Показывать тест на странице",
    showInWindow: "Показывать тест в модальном окне",
    loadFromServer: "Загрузить Json теста с сервера",
  ...
  triggers: {
    completetrigger: "Завершить тест",
  ...
  pehelp: {
    panel: {
      ...
      requiredIf: "Используйте значок волшебной палочки, чтобы задать условное правило, которое запрещает отправку теста, если хотя бы один вложенный вопрос не содержит ответа.",
      questionTitleLocation: "Применяется ко всем вопросам в этой панели. Если вы хотите переопределить этот параметр, определите правила выравнивания заголовков для отдельных вопросов. Опция «Наследовать» применяет настройку на уровне страницы (если задано) или на уровне теста («Сверху» по умолчанию).",
      questionErrorLocation: "Задает расположение сообщения об ошибке по отношению ко всем вопросам на панели. Опция «Наследовать» применяет настройку на уровне страницы (если задано) или на уровне теста.",
      questionsOrder: "Сохраняет исходный порядок вопросов или рандомизирует их. Опция «Наследовать» применяет настройку на уровне страницы (если задано) или на уровне теста.",
    ...
    paneldynamic: {
      ...
      enableIf: "Используйте значок волшебной палочки, чтобы задать условное правило, которое отключает режим только для чтения для панели.",
      requiredIf: "Используйте значок волшебной палочки, чтобы задать условное правило, которое запрещает отправку теста, если хотя бы один вложенный вопрос не содержит ответа.",
      templateTitleLocation: "Применяется ко всем вопросам в этой панели. Если вы хотите переопределить этот параметр, определите правила выравнивания заголовков для отдельных вопросов. Опция «Наследовать» применяет настройку на уровне страницы (если задано) или на уровне теста («Сверху» по умолчанию).",
      templateErrorLocation: "Задает расположение сообщения об ошибке по отношению к вопросу с недопустимыми входными данными. Выберите между: «Сверху» - текст ошибки размещается в верхней части поля вопроса; «Внизу» - текст ошибки размещается в нижней части окна вопроса. Опция «Наследовать» применяет настройку на уровне страницы (если задано) или на уровне теста («Сверху» по умолчанию).",
      errorLocation: "Задает расположение сообщения об ошибке по отношению ко всем вопросам на панели. Опция «Наследовать» применяет настройку на уровне страницы (если задано) или на уровне теста.",
      page: "Перемещает панель в конец выбранной страницы.",
      innerIndent: "Добавляет пространство или поле между содержимым панели и левой границей рамки панели.",
      startWithNewLine: "Снимите флажок, чтобы отобразить панель в одной строке с предыдущим вопросом или панелью. Этот параметр не применяется, если панель является первым элементом формы.",
      state: "Выберите из: «Развернутая» - панель отображается полностью и может быть свернута; «Свернутая» - панель отображает только заголовок и описание и может быть развернута; «Заблокировано» - панель отображается полностью и не может быть свернута.",
      ...
      titleLocation: "Этот параметр автоматически наследуется всеми вопросами на этой панели. Если вы хотите переопределить этот параметр, определите правила выравнивания заголовков для отдельных вопросов. Опция «Наследовать» применяет настройку на уровне страницы (если задано) или на уровне теста («Сверху» по умолчанию).",
      descriptionLocation: "Опция «Наследовать» применяет настройку на уровне страницы (если задано) или на уровне теста («Под заголовком панели» по умолчанию).",
    ...
    question: {
      ...
      requiredIf: "Используйте значок волшебной палочки, чтобы установить условное правило, которое запрещает продвижение или отправку теста, если на вопрос не получен ответ.",
      ...
      titleLocation: "Переопределяет правила выравнивания заголовков, заданные на уровне панели, страницы или теста. Опция «Наследовать» применяет любые настройки более высокого уровня (если они установлены) или настройки уровня теста («Сверху» по умолчанию).",
      descriptionLocation: "Опция «Наследовать» применяет настройку на уровне теста (по умолчанию «Под заголовком вопроса»).",
      errorLocation: "Задает расположение сообщения об ошибке по отношению к вопросу с недопустимыми входными данными. Выберите между: «Сверху» - текст ошибки размещается в верхней части поля вопроса; «Внизу» - текст ошибки размещается в нижней части окна вопроса. Опция «Наследовать» применяет настройку уровня теста («Сверху» по умолчанию).",
      indent: "Добавляет пробел или поле между содержимым вопроса и левой границей поля вопроса.",
      width: "Устанавливает ширину вопроса пропорционально другим элементам теста в той же строке. Принимает значения CSS (px, %, in, pt и т. д.).",
      surveyvalidator: {
        expression: "Используйте значок волшебной палочки, чтобы задать правило проверки для вопроса."
      },
      textUpdateMode: "Выберите из: \"При потере фокуса\" - значение обновляется при потере фокуса полем ввода; \"Во время набора\" - значение обновляется в режиме реального времени, по мере набора текста пользователями. Опция «Наследовать» применяет настройку на уровне теста (по умолчанию «При потере фокуса»).",
    ...
    // survey templates
    survey: {
      mode: "Выберите один из следующих вариантов: «Редактируемый» - позволяет респондентам заполнять Ваш тест; \"Только для чтения\" - отключает редактирование формы."
    },
    matrixdropdowncolumn: {
    ...
    widthMode: "Выберите один из: \"Статический\" - задает фиксированную ширину; «Отзывчивый» - заставляет тест занимать всю ширину экрана; \"Авто\" - применяет любой из двух вариантов в зависимости от используемых типов вопросов.",
    cookieName: "Файлы cookie не позволяют пользователям заполнять один и тот же тест дважды.",
    ...
    goNextPageAutomatic: "Выберите, хотите ли вы, чтобы тест автоматически переходил на следующую страницу после того, как респондент ответит на все вопросы на текущей странице.",
    allowCompleteSurveyAutomatic: "Выберите, хотите ли Вы, чтобы тест завершался автоматически после того, как респондент ответит на все вопросы.",
    showNavigationButtons: "Задает видимость и расположение кнопок навигации на странице.",
    showProgressBar: "Задает видимость и расположение индикатора выполнения. Значение «Авто» отображает индикатор выполнения над или под заголовком теста.",
    ...
    includeIntoResult: "Выберите, если вы хотите, чтобы вычисленное значение выражения сохранялось вместе с результатами теста.",
    ...
    keyName: "Если указанный столбец содержит одинаковые значения, тест выдает ошибку «Неуникальное значение ключа».",
    description: "Введите субтитры.",
    locale: "Выберите язык, чтобы начать создание теста. Чтобы добавить перевод, переключитесь на новый язык и переведите исходный текст здесь или во вкладке «Переводы».",
    ...
    maxTimeToFinish: "Интервал времени в секундах, по истечении которого тест автоматически переходит на страницу благодарности.",
    maxTimeToFinishPage: "Интервал времени в секундах, по истечении которого тест автоматически переходит на следующую страницу.",
    page: {
      maxTimeToFinish: "Интервал времени в секундах, по истечении которого тест автоматически переходит на следующую страницу.",
      ...
      requiredIf: "Используйте значок волшебной палочки, чтобы задать условное правило, которое запрещает отправку теста, если хотя бы один вложенный вопрос не содержит ответа.",
      questionTitleLocation: "Относится ко всем вопросам на этой странице. Если вы хотите переопределить этот параметр, задайте правила выравнивания заголовков для отдельных вопросов или панелей. Опция «Наследовать» применяет настройку уровня теста («Сверху» по умолчанию).",
      ...
      questionsOrder: "Сохраняет исходный порядок вопросов или рандомизирует их. Опция «Наследовать» применяет настройку уровня теста («Оригинал» по умолчанию). Эффект этого параметра виден только на вкладке «Предварительный просмотр».",
      navigationButtonsVisibility: "Задает видимость кнопок навигации на странице. Опция \"Наследовать\" применяет настройку уровня теста, которая по умолчанию имеет значение \"Видимый\"."
    },
    ...
    waitForUpload: "Гарантирует, что пользователи не завершат тест до тех пор, пока файлы не будут загружены.",
    ...
    useDisplayValuesInDynamicTexts: "В вопросах с одним и несколькими вариантами ответов каждый вариант выбора имеет идентификатор и отображаемое значение. Если этот параметр установлен, в HTML-вопросах, а также в динамических заголовках и описаниях элементов теста отображается отображаемое значение, а не значение идентификатора.",
    clearIfInvisible: "Выберите, следует ли очищать значения вопросов, скрытые условной логикой, и когда это делать. Опция «Наследовать» применяет настройку на уровне теста («По завершении опроса» по умолчанию).",
    ...
    valueTrue: "Значение, сохраняемое в результатах теста, когда респонденты дают положительный ответ.",
    valueFalse: "Значение, сохраняемое в результатах теста, когда респонденты дают отрицательный ответ.",
    ...
    rateColorMode: "Определяет цвет выбранного эмодзи, если для параметра «Тип значка рейтинга» установлено значение «Смайлики». Выберите между: \"По умолчанию\" - выбранный эмодзи отображается в цвете теста по умолчанию; «Шкала» - выбранный эмодзи наследует цвет от шкалы оценки.",
    expression: {
    ...
    storeOthersAsComment: "Выберите, чтобы сохранить значение параметра «Другое» как отдельное свойство в результатах теста.",
    ...
    masksettings: {
      saveMaskedValue: "Выберите, хотите ли вы сохранить значение вопроса с примененной маской в результатах теста."
    },
    patternmask: {
  ...
  p: {
    ...
    surveyId: "Идентификатор теста",
    surveyPostId: "Идентификатор записи теста",
    surveyShowDataSaving: "Тест показывает сохранение данных",
  ...
  theme: {
    ...
    surveyTitle: "Шрифт заголовка теста",
    surveyDescription: "Шрифт описания теста",
    ...
    coverInheritWidthFromSurvey: "То же, что и тест",
...
surveyLocalization.locales["ru"] = ruStrings;
...
// ed.saveSurveyTooltip: "Save Survey" => "Сохранить тест"
...
// pe.completedBeforeHtml: "Markup to show if the user already filled out this survey" => "Разметка, показывающая, заполнил ли пользователь уже этот тест"
// pe.completedHtml: "Survey Complete page markup" => "Опрос Полная разметка страницы"
// pe.completedHtmlOnCondition: "Dynamic Survey Complete page markup" => "Динамический тест Полная разметка страницы"
...
// pehelp.cookieName: "Cookies prevent users from filling out the same survey twice." => "Файлы cookie не позволяют пользователям заполнять один и тот же тест дважды."
...
// pehelp.keyName: "If the specified column contains identical values, the survey throws the \"Non-unique key value\" error." => "Если указанный столбец содержит одинаковые значения, тест выдает ошибку «Неуникальное значение ключа»."
...
// theme.coverInheritWidthFromSurvey: "Same as survey" => "То же, что и тест"
...
// showQuestionNumbers.onPanel: "Reset on each panel" => "Сброс на каждой панели"
// showQuestionNumbers.onSurvey: "Continue across the survey" => "Продолжить тест"
...
// survey.mode: "Choose between: \"Editable\" - enables respondents to fill out your survey; \"Read-only\" - disables form editing." => "Выберите один из следующих вариантов: «Редактируемый» - позволяет респондентам заполнять Ваш тест; \"Только для чтения\" - отключает редактирование формы."
...
// pehelp.goNextPageAutomatic: "Select if you want the survey to advance to the next page automatically after a respondent answers all questions on the current page." => "Выберите, хотите ли вы, чтобы тест автоматически переходил на следующую страницу после того, как респондент ответит на все вопросы на текущей странице."
...
// pehelp.maxTimeToFinish: "A time interval in seconds after which the survey auto-advances to the Thank You page." => "Интервал времени в секундах, по истечении которого тест автоматически переходит на страницу благодарности."
// pehelp.maxTimeToFinishPage: "A time interval in seconds after which the survey auto-advances to the next page." => "Интервал времени в секундах, по истечении которого тест автоматически переходит на следующую страницу."
// page.maxTimeToFinish: "A time interval in seconds after which the survey auto-advances to the next page." => "Интервал времени в секундах, по истечении которого тест автоматически переходит на следующую страницу."
...
// pehelp.waitForUpload: "Ensures that users won't complete the survey until files are uploaded." => "Гарантирует, что пользователи не завершат тест до тех пор, пока файлы не будут загружены."
...
// pehelp.allowCompleteSurveyAutomatic: "Select if you want the survey to complete automatically after a respondent answers all questions." => "Выберите, хотите ли Вы, чтобы тест завершался автоматически после того, как респондент ответит на все вопросы."
